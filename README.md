...
├── module.prop         (Module metadata - v1.7.0)
├── service.sh          (Startup background daemon - Unix LF format)
├── PlayAudio.dex       (Headless Android Java compiled helper with MediaDataSource)
├── charging.ogg        (Official Xiaomi plug-in sound - 82 KB)
├── disconnect.ogg      (Official Xiaomi plug-out sound - 7 KB)
├── changelog.txt       (English changelog - v1.7.0)
├── README.md           (English guide - v1.7.0)
├── META-INF/
│   └── com/google/android/
...
1. Download `Xiaomi-Charging-Sound-v1.7.0.zip` or `xiaomi-charging-sound-universal.zip`.
